...
let torontoData = "https://raw.githubusercontent.com/Josiebeepboop/mapping_earthquakes/Mapping_GeoJSON_Linestrings/torontoRoutes.json";
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJSON(data, {
    ...
    onEachFeature: function(feature,layer){
      layer.bindPopup("<h3> Airline: " + feature.properties.airline + "</h3> <hr> <h3> Destinations:" + feature.properties.dst + "<h/3>");
    }
  }).addTo(map);
});
